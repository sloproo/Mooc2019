...
@Points("10-05")
public class PelaajaJaTekoalyTest {

    @Test
    public void onLuokat() {
        onYksityinenAttribuutti("Pelaaja", "nimi", String.class);
        rajattuAttribuuttienMaara("Pelaaja", 1);
        rajattuAttribuuttienMaara("Tekoaly", 0);

        luokkaPeriiToisen("Tekoaly", "Pelaaja");
    }

    public void luokkaPeriiToisen(String luokka, String toinen) {
        ...
        assertTrue("Periihän luokka " + luokka + " luokan " + toinen + "?", toinenClass.isAssignableFrom(luokkaClass));
    }
