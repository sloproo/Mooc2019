...
public class B_MatkalaukkuTest<_Tavara, _Matkalaukku> extends TestUtils {
    ...
    public void setup() {
        ...
        try {
            ...
            matkalaukkuClass = ReflectionUtils.findClass(klassName);
    ...
    public void testaaMatkalaukkuKonstruktori() throws Throwable {
        ...
        assertTrue("Määrittele luokalle " + s(klassName) + " julkinen konstruktori: public " + s(klassName) + "(int maksimipaino)", ctor.isPublic());
