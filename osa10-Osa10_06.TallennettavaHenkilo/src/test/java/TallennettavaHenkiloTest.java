...
@Points("10-06")
public class TallennettavaHenkiloTest {

    @Test
    public void onLuokat() {
        onYksityinenAttribuutti("Henkilo", "nimi", String.class);
        onYksityinenAttribuutti("Henkilo", "osoite", String.class);
        rajattuAttribuuttienMaara("Henkilo", 2);

        onRajapinta("Tallennettava");
        onMetodi("Tallennettava", "tallenna", void.class);
        onMetodi("Tallennettava", "poista", void.class);
        onMetodi("Tallennettava", "lataa", void.class, String.class);

        luokkaPeriiTaiToteuttaaToisen("Henkilo", "Tallennettava");
    }
